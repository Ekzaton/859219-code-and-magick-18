...
(function () {
  ...
  var renderBar = function (ctx, names, times) {
    for (var i = 0; i < names.length; i++) {
      ...
      ctx.fillStyle = (names[i] === 'Вы') ? Color.RED : getColor(Hsl.HUE, Hsl.MIN_SATURATION, Hsl.MAX_SATURATION, Hsl.LIGHTNESS);
  ...
  window.renderStatistics = function (ctx, names, times) {
    renderCloud(ctx, Cloud.X + Cloud.GAP, Cloud.Y + Cloud.GAP, Color.GRAY);
